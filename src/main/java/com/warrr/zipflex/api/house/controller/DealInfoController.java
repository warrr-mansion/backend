...
public class DealInfoController {
    ...
    public BaseResponse<PageResponseDto<DealInfoResponseDto>> getDealInfoByFilterWithPagination(
        ...
        return new BaseResponse<>(dealInfoService.getDealInfoByFilterWithPagination(buildingType,
                        contractType, sgg, emd, requestDto));
    }
    ...
    @GetMapping("/id/{id}/page")
    public BaseResponse<PageResponseDto<DealInfoResponseDto>> getDealInfoByHouseInfoIdWithPagination(
