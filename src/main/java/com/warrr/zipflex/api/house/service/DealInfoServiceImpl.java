...
public class DealInfoServiceImpl implements DealInfoService {
	...
	@Autowired private ApartmentDealDao apartmentDealDao;
	@Autowired private OfficetelDealDao officetelDealDao;
	@Autowired private VillaDealDao villaDealDao;
	
	
	@Override
	public List<DealInfoResponseDto> getDealInfoByFilter(String buildingType, String contractType, String sgg, String emd) {
	...
	@Override
	public List<DealInfoResponseDto> getDealInfoByHouseInfoId(String buildingType, String houseInfoId) {
	    if ("APARTMENT".equals(buildingType)) {
